        ...
        <div class="right">
          ...
          <form id="change_password" accept-charset="UTF-8" method="post">
            ...
            <dl>
              ...
              <dd>
                <input type="password" required="required" id="password" name="new_password" />
              </dd>
            </dl>
            <dl>
              <dt>
              ...
              <dd>
                <input type="password" required="required" id="confirm" name="confirm_password"
                       oninput="confirmCheck(new_password, confirm_password);" />
              </dd>
            </dl>
